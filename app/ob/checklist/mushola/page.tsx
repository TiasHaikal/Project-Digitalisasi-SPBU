...
export default function ChecklistMusholaPage() {
  ...
  //Fungsi Ekspor PDF untuk Mushola ---
  const handleExportPDF = () => {
    ...
    doc.text(
      "CHECKLIST KEGIATAN HOUSEKEEPING MUSHOLA",
    ...
    const activities = [
      {
        value: "PERIKSA_KEBERSIHAN_DAN_KERUSAKAN_SECARA_VISUAL",
        label: "Periksa kebersihan dan kerusakan secara visual",
      },
      {
        value: "PERIKSA_FUNGSI_AC_PINTU_LAMPU_DAN_JENDELA",
        label: "Periksa fungsi AC, Pintu, Lampu & Jendela",
      },
      {
        value: "SEMROTKAN_PENGISI_RUANGAN",
        label: "Semprotkan pewangi ruangan",
      },
      {
        value: "SAPU_LANTAI_DAERAH_MUSHOLA",
        label: "Sapu lantai daerah mushola",
      },
      {
        value: "SAPU_DAN_LAP_DAERAH_PENYIMPANAN_SEPATU",
        label: "Sapu & lap daerah penyimpanan sepatu",
      },
      { value: "BERSIHKAN_JENDELA", label: "Bersihkan jendela" },
      { value: "BERSIHKAN_PINTU", label: "Bersihkan pintu" },
      { value: "BERSIHKAN_DINDING", label: "Bersihkan dinding (sawang)" },
      {
        value: "GANTI_DAN_CUCI_KESET_PINTU",
        label: "Ganti dan cuci keset pintu",
      },
      { value: "CUCI_SAJADAH", label: "Cuci sajadah" },
    ];
    ...
    const body = activities.map((activity) => {
      ...
      const checksForActivity = checklists.filter(
        (c) => c.aktifitasMushola === activity.value
      );
    ...
    doc.save(`Checklist_Mushola_${spbu}_${monthName}_${year}.pdf`);
  };
              ...
              <TableBody>
                {checklists.map((c) => (
                  <TableRow key={c.id}>
                    ...
                    <TableCell>
                      {c.aktifitasMushola.replace(/_/g, " ")}
                    </TableCell>
                    <TableCell>
